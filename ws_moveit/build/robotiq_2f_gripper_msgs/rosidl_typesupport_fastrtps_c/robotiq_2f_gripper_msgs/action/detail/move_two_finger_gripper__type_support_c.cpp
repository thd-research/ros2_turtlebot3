  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_Goal__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: target_position
  {
    cdr >> ros_message->target_position;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_Result__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_Feedback__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: feedback
  {
    std::string tmp;
    cdr >> tmp;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_SendGoal_Request__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_SendGoal_Response__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_GetResult_Request__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_GetResult_Response__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_gripper_msgs, action, MoveTwoFingerGripper_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MoveTwoFingerGripper_FeedbackMessage__ros_msg_type * ros_message = static_cast<_MoveTwoFingerGripper_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(

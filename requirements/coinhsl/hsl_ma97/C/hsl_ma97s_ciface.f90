...
contains
   ...
   subroutine copy_info_out(finfo,cinfo)
      ...
      cinfo%maxsupernode         = finfo%maxsupernode
   end subroutine copy_info_out
end module hsl_ma97_single_ciface

subroutine ma97_default_control_s(ccontrol) bind(C)
   use hsl_ma97_single_ciface
   implicit none
...
end subroutine ma97_default_control_s

subroutine ma97_analyse_s(ccheck, n, cptr, crow, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
   use hsl_ma97_single_ciface
   implicit none
...
end subroutine ma97_analyse_s

subroutine ma97_analyse_coord_s(n, ne, crow, ccol, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
   use hsl_ma97_single_ciface
   implicit none
...
end subroutine ma97_analyse_coord_s

subroutine ma97_factor_s(matrix_type, cptr, crow, cval, cakeep, cfkeep, &
   ...
   type(f_ma97_control) :: fcontrol
   type(f_ma97_info) :: finfo
   real(wp), dimension(:), pointer :: fscale
   logical :: f_arrays
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_factor_s

subroutine ma97_factor_solve_s(matrix_type, cptr, crow, cval, nrhs, cx, ldx, &
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_factor_solve_s

subroutine ma97_solve_s(job, nrhs, cx, ldx, cakeep, cfkeep, ccontrol, cinfo) &
      bind(C)
   use hsl_ma97_single_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_solve_s

subroutine ma97_free_akeep_s(cakeep) bind(C)
   use hsl_ma97_single_ciface
   implicit none
...
end subroutine ma97_free_akeep_s

subroutine ma97_free_fkeep_s(cfkeep) bind(C)
   use hsl_ma97_single_ciface
   implicit none
...
end subroutine ma97_free_fkeep_s

subroutine ma97_finalise_s(cakeep, cfkeep) bind(C)
   use hsl_ma97_single_ciface
   implicit none
   ...
   call ma97_free_akeep_s(cakeep)
   call ma97_free_fkeep_s(cfkeep)
end subroutine ma97_finalise_s

subroutine ma97_enquire_posdef_s(cakeep, cfkeep, ccontrol, cinfo, cd) bind(C)
   use hsl_ma97_single_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_enquire_posdef_s

subroutine ma97_enquire_indef_s(cakeep, cfkeep, ccontrol, cinfo, cpiv_order, &
      cd) bind(C)
   use hsl_ma97_single_ciface
   implicit none
...
end subroutine ma97_enquire_indef_s

subroutine ma97_alter_s(cd, cakeep, cfkeep, ccontrol, cinfo) bind(C)
   use hsl_ma97_single_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_alter_s

subroutine ma97_solve_fredholm_s(nrhs, cflag_out, cx, ldx, cakeep, cfkeep, &
...
end subroutine ma97_solve_fredholm_s

subroutine ma97_lmultiply_s(ctrans, k, cx, ldx, cy, ldy, cakeep, cfkeep, &
      ccontrol, cinfo) bind(C)
   use hsl_ma97_single_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_lmultiply_s

subroutine ma97_sparse_fwd_solve_s(nbi, cbindex, cb, corder, cnxi, &
...
end subroutine ma97_sparse_fwd_solve_s
